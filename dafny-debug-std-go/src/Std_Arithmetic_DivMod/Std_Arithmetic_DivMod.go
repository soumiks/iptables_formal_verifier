// Package Std_Arithmetic_DivMod
// Dafny module Std_Arithmetic_DivMod compiled into Go
...
func (*Default__) String() string {
	return "Std_Arithmetic_DivMod.Default__"
}
...
func (_static *CompanionStruct_Default___) MultiplesVanish(a _dafny.Int, b _dafny.Int, m _dafny.Int) bool {
	return ((((m).Times(a)).Plus(b)).Modulo(m)).Cmp((b).Modulo(m)) == 0
}
