// Package Std_Collections_Tuple
// Dafny module Std_Collections_Tuple compiled into Go
...
func (*Default__) String() string {
	return "Std_Collections_Tuple.Default__"
}
...
func (_static *CompanionStruct_Default___) T2__0() func(_dafny.Tuple) interface{} {
	return func(_0_lr _dafny.Tuple) interface{} {
		return (*(_0_lr).IndexInt(0))
	}
}
func (_static *CompanionStruct_Default___) T2__1() func(_dafny.Tuple) interface{} {
	return func(_0_lr _dafny.Tuple) interface{} {
		return (*(_0_lr).IndexInt(1))
	}
}
