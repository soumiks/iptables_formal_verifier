...
func (_static *CompanionStruct_Default___) Serialize(js m_Std_JSON_Values.JSON) m_Std_Wrappers.Result {
	var _0_valueOrError0 m_Std_Wrappers.Result = m_Std_JSON_Serializer.Companion_Default___.JSON(js)
	_ = _0_valueOrError0
	if (_0_valueOrError0).IsFailure() {
		return (_0_valueOrError0).PropagateFailure()
	} else {
		var _1_js m_Std_JSON_Grammar.Structural = (_0_valueOrError0).Extract().(m_Std_JSON_Grammar.Structural)
		_ = _1_js
		return m_Std_JSON_ZeroCopy_API.Companion_Default___.Serialize(_1_js)
	}
}
func (_static *CompanionStruct_Default___) SerializeAlloc(js m_Std_JSON_Values.JSON) m_Std_Wrappers.Result {
	var bs m_Std_Wrappers.Result = m_Std_Wrappers.Companion_Result_.Default(_dafny.NewArrayWithValue(nil, _dafny.IntOf(0)))
	_ = bs
	var _0_valueOrError0 m_Std_Wrappers.Result = m_Std_Wrappers.Companion_Result_.Default(m_Std_JSON_Grammar.Companion_Structural_.Default(m_Std_JSON_Grammar.Companion_Value_.Default()))
	_ = _0_valueOrError0
	_0_valueOrError0 = m_Std_JSON_Serializer.Companion_Default___.JSON(js)
	if (_0_valueOrError0).IsFailure() {
		bs = (_0_valueOrError0).PropagateFailure()
		return bs
	}
	var _1_js m_Std_JSON_Grammar.Structural
	_ = _1_js
	_1_js = (_0_valueOrError0).Extract().(m_Std_JSON_Grammar.Structural)
	var _out0 m_Std_Wrappers.Result
	_ = _out0
	_out0 = m_Std_JSON_ZeroCopy_API.Companion_Default___.SerializeAlloc(_1_js)
	bs = _out0
	return bs
}
func (_static *CompanionStruct_Default___) SerializeInto(js m_Std_JSON_Values.JSON, bs _dafny.Array) m_Std_Wrappers.Result {
	...
	var _out0 m_Std_Wrappers.Result
	_ = _out0
	_out0 = m_Std_JSON_ZeroCopy_API.Companion_Default___.SerializeInto(_1_js, bs)
	len_ = _out0
	return len_
}
func (_static *CompanionStruct_Default___) Deserialize(bs _dafny.Sequence) m_Std_Wrappers.Result {
	var _0_valueOrError0 m_Std_Wrappers.Result = m_Std_JSON_ZeroCopy_API.Companion_Default___.Deserialize(bs)
	_ = _0_valueOrError0
	if (_0_valueOrError0).IsFailure() {
		return (_0_valueOrError0).PropagateFailure()
	} else {
		var _1_js m_Std_JSON_Grammar.Structural = (_0_valueOrError0).Extract().(m_Std_JSON_Grammar.Structural)
		_ = _1_js
		return m_Std_JSON_Deserializer.Companion_Default___.JSON(_1_js)
	}
}
