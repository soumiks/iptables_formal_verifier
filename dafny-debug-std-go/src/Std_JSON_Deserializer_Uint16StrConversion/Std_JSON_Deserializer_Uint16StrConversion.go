...
TAIL_CALL_START:
	if _dafny.Companion_Sequence_.Equal(digits, _dafny.SeqOf()) {
		...
		_0___accumulator = _dafny.Companion_Sequence_.Concatenate(_dafny.SeqOf((Companion_Default___.Chars()).Select(((digits).Select(0).(_dafny.Int)).Uint32()).(uint16)), _0___accumulator)
...
func (_static *CompanionStruct_Default___) IsNumberStr(str _dafny.Sequence, minus uint16) bool {
	return !(!_dafny.Companion_Sequence_.Equal(str, _dafny.SeqOf())) || (((((str).Select(0).(uint16)) == (minus)) || ((Companion_Default___.CharToDigit()).Contains((str).Select(0).(uint16)))) && (_dafny.Quantifier(((str).Drop(1)).UniqueElements(), true, func(_forall_var_0 uint16) bool {
		var _0_c uint16
...
func (_static *CompanionStruct_Default___) ToNat(str _dafny.Sequence) _dafny.Int {
	if _dafny.Companion_Sequence_.Equal(str, _dafny.SeqOf()) {
		...
		var _0_c uint16 = (str).Select(((_dafny.IntOfUint32((str).Cardinality())).Minus(_dafny.One)).Uint32()).(uint16)
		_ = _0_c
