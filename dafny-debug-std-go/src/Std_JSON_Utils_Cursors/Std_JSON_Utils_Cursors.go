		...
		}
		{
			if _source0.Is_ExpectingByte() {
				...
				var _2_c _dafny.Sequence = (func() _dafny.Sequence {
					if (_1_b) > (int16(0)) {
						return _dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.UnicodeSeqOfUtf8Bytes("'"), _dafny.SeqOf(_dafny.CodePoint((_1_b)))), _dafny.UnicodeSeqOfUtf8Bytes("'"))
					}
					return _dafny.UnicodeSeqOfUtf8Bytes("EOF")
				})()
				_ = _2_c
				return _dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.UnicodeSeqOfUtf8Bytes("Expecting '"), _dafny.SeqOf(_dafny.CodePoint((_0_b0)))), _dafny.UnicodeSeqOfUtf8Bytes("', read ")), _2_c)
			}
		}
		{
			if _source0.Is_ExpectingAnyByte() {
				...
				var _5_c _dafny.Sequence = (func() _dafny.Sequence {
					if (_4_b) > (int16(0)) {
						return _dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.UnicodeSeqOfUtf8Bytes("'"), _dafny.SeqOf(_dafny.CodePoint((_4_b)))), _dafny.UnicodeSeqOfUtf8Bytes("'"))
					}
					return _dafny.UnicodeSeqOfUtf8Bytes("EOF")
				})()
				_ = _5_c
				var _6_c0s _dafny.Sequence = _dafny.SeqCreate((_dafny.IntOfUint32((_3_bs0).Cardinality())).Uint32(), func(coer38 func(_dafny.Int) _dafny.CodePoint) func(_dafny.Int) interface{} {
					return func(arg39 _dafny.Int) interface{} {
						return coer38(arg39)
					}
				}((func(_7_bs0 _dafny.Sequence) func(_dafny.Int) _dafny.CodePoint {
					return func(_8_idx _dafny.Int) _dafny.CodePoint {
						return _dafny.CodePoint(((_7_bs0).Select((_8_idx).Uint32()).(uint8)))
					}
				})(_3_bs0)))
				_ = _6_c0s
				return _dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.UnicodeSeqOfUtf8Bytes("Expecting one of '"), _6_c0s), _dafny.UnicodeSeqOfUtf8Bytes("', read ")), _5_c)
			}
		}
		{
...
func (_static CompanionStruct_Cursor___) OfView(v m_Std_JSON_Utils_Views_Core.View__) Cursor__ {
...
func (_this Cursor__) Prefix() m_Std_JSON_Utils_Views_Core.View__ {
	{
		return m_Std_JSON_Utils_Views_Core.Companion_View___.Create_View_((_this).Dtor_s(), (_this).Dtor_beg(), (_this).Dtor_point())
	}
}
...
func (_this Cursor__) Get(err interface{}) m_Std_Wrappers.Result {
	{
		if (_this).EOF_q() {
			return m_Std_Wrappers.Companion_Result_.Create_Failure_(Companion_CursorError_.Create_OtherError_(err))
		} else {
			return m_Std_Wrappers.Companion_Result_.Create_Success_((_this).Skip(uint32(1)))
		}
	}
}
func (_this Cursor__) AssertByte(b uint8) m_Std_Wrappers.Result {
	{
		...
		if (_0_nxt) == (int16(b)) {
			...
			return m_Std_Wrappers.Companion_Result_.Create_Failure_(Companion_CursorError_.Create_ExpectingByte_(b, _0_nxt))
		}
	}
}
func (_this Cursor__) AssertBytes(bs _dafny.Sequence, offset uint32) m_Std_Wrappers.Result {
	{
		goto TAIL_CALL_START
	TAIL_CALL_START:
		if (offset) == (uint32((bs).Cardinality())) {
			return m_Std_Wrappers.Companion_Result_.Create_Success_(_this)
		} else {
			var _0_valueOrError0 m_Std_Wrappers.Result = (_this).AssertByte((bs).Select(uint32(offset)).(uint8))
			_ = _0_valueOrError0
...
func (_this Cursor__) AssertChar(c0 _dafny.CodePoint) m_Std_Wrappers.Result {
	{
...
func (_this Cursor__) SkipWhileLexer(step func(interface{}, int16) m_Std_JSON_Utils_Lexers_Core.LexerResult, st interface{}) m_Std_Wrappers.Result {
	{
		var pr m_Std_Wrappers.Result = m_Std_Wrappers.Companion_Result_.Default(Companion_Cursor_.Witness())
		_ = pr
		var _0_point_k uint32
		_ = _0_point_k
		_0_point_k = (_this).Dtor_point()
		...
		for true {
			...
			var _source0 m_Std_JSON_Utils_Lexers_Core.LexerResult = (step)(_2_st_k, _5_c)
			_ = _source0
			{
				{
					if _source0.Is_Accept() {
						pr = m_Std_Wrappers.Companion_Result_.Create_Success_(Companion_Cursor___.Create_Cursor_((_this).Dtor_s(), (_this).Dtor_beg(), _0_point_k, (_this).Dtor_end()))
						return pr
						goto Lmatch0
					}
				}
				{
					if _source0.Is_Reject() {
						var _6_err interface{} = _source0.Get_().(m_Std_JSON_Utils_Lexers_Core.LexerResult_Reject).Err
						_ = _6_err
						pr = m_Std_Wrappers.Companion_Result_.Create_Failure_(Companion_CursorError_.Create_OtherError_(_6_err))
						return pr
						goto Lmatch0
					}
				}
				{
					var _7_st_k_k interface{} = _source0.Get_().(m_Std_JSON_Utils_Lexers_Core.LexerResult_Partial).St
					_ = _7_st_k_k
					if _3_eof {
						pr = m_Std_Wrappers.Companion_Result_.Create_Failure_(Companion_CursorError_.Create_EOF_())
						return pr
					} else {
						_2_st_k = _7_st_k_k
						_0_point_k = (_0_point_k) + (uint32(1))
