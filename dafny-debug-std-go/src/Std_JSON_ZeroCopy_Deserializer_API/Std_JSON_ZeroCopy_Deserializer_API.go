...
func (_static *CompanionStruct_Default___) LiftCursorError(err m_Std_JSON_Utils_Cursors.CursorError) m_Std_JSON_Errors.DeserializationError {
	var _source0 m_Std_JSON_Utils_Cursors.CursorError = err
	_ = _source0
	{
		if _source0.Is_EOF() {
			return m_Std_JSON_Errors.Companion_DeserializationError_.Create_ReachedEOF_()
		}
	}
	{
		if _source0.Is_ExpectingByte() {
			var _0_expected uint8 = _source0.Get_().(m_Std_JSON_Utils_Cursors.CursorError_ExpectingByte).Expected
			_ = _0_expected
			var _1_b int16 = _source0.Get_().(m_Std_JSON_Utils_Cursors.CursorError_ExpectingByte).B
			_ = _1_b
			return m_Std_JSON_Errors.Companion_DeserializationError_.Create_ExpectingByte_(_0_expected, _1_b)
		}
	}
	{
		if _source0.Is_ExpectingAnyByte() {
			var _2_expected__sq _dafny.Sequence = _source0.Get_().(m_Std_JSON_Utils_Cursors.CursorError_ExpectingAnyByte).Expected__sq
			_ = _2_expected__sq
			var _3_b int16 = _source0.Get_().(m_Std_JSON_Utils_Cursors.CursorError_ExpectingAnyByte).B
			_ = _3_b
			return m_Std_JSON_Errors.Companion_DeserializationError_.Create_ExpectingAnyByte_(_2_expected__sq, _3_b)
		}
	}
	{
		var _4_err m_Std_JSON_Errors.DeserializationError = _source0.Get_().(m_Std_JSON_Utils_Cursors.CursorError_OtherError).Err.(m_Std_JSON_Errors.DeserializationError)
		_ = _4_err
		return _4_err
	}
}
func (_static *CompanionStruct_Default___) JSON(cs m_Std_JSON_Utils_Cursors.Cursor__) m_Std_Wrappers.Result {
	return (m_Std_JSON_ZeroCopy_Deserializer_Core.Companion_Default___.Structural(cs, func(coer60 func(m_Std_JSON_Utils_Cursors.Cursor__) m_Std_Wrappers.Result) func(m_Std_JSON_Utils_Cursors.Cursor__) m_Std_Wrappers.Result {
		return func(arg61 m_Std_JSON_Utils_Cursors.Cursor__) m_Std_Wrappers.Result {
			return coer60(arg61)
		}
	}(m_Std_JSON_ZeroCopy_Deserializer_Values.Companion_Default___.Value))).MapFailure(func(coer61 func(m_Std_JSON_Utils_Cursors.CursorError) m_Std_JSON_Errors.DeserializationError) func(interface{}) interface{} {
		return func(arg62 interface{}) interface{} {
			return coer61(arg62.(m_Std_JSON_Utils_Cursors.CursorError))
		}
	}(Companion_Default___.LiftCursorError))
}
func (_static *CompanionStruct_Default___) Text(v m_Std_JSON_Utils_Views_Core.View__) m_Std_Wrappers.Result {
	var _0_valueOrError0 m_Std_Wrappers.Result = Companion_Default___.JSON(m_Std_JSON_Utils_Cursors.Companion_Cursor___.OfView(v))
	_ = _0_valueOrError0
	if (_0_valueOrError0).IsFailure() {
		return (_0_valueOrError0).PropagateFailure()
	} else {
		var _let_tmp_rhs0 m_Std_JSON_Utils_Cursors.Split = (_0_valueOrError0).Extract().(m_Std_JSON_Utils_Cursors.Split)
		_ = _let_tmp_rhs0
		var _1_text m_Std_JSON_Grammar.Structural = _let_tmp_rhs0.Get_().(m_Std_JSON_Utils_Cursors.Split_SP).T.(m_Std_JSON_Grammar.Structural)
		_ = _1_text
		var _2_cs m_Std_JSON_Utils_Cursors.Cursor__ = _let_tmp_rhs0.Get_().(m_Std_JSON_Utils_Cursors.Split_SP).Cs
		_ = _2_cs
		var _3_valueOrError1 m_Std_Wrappers.OutcomeResult = m_Std_Wrappers.Companion_Default___.Need((_2_cs).EOF_q(), m_Std_JSON_Errors.Companion_DeserializationError_.Create_ExpectingEOF_())
		_ = _3_valueOrError1
		if (_3_valueOrError1).IsFailure() {
			return (_3_valueOrError1).PropagateFailure()
		} else {
			return m_Std_Wrappers.Companion_Result_.Create_Success_(_1_text)
		}
	}
}
func (_static *CompanionStruct_Default___) OfBytes(bs _dafny.Sequence) m_Std_Wrappers.Result {
	var _0_valueOrError0 m_Std_Wrappers.OutcomeResult = m_Std_Wrappers.Companion_Default___.Need((_dafny.IntOfUint32((bs).Cardinality())).Cmp(m_Std_BoundedInts.Companion_Default___.TWO__TO__THE__32()) < 0, m_Std_JSON_Errors.Companion_DeserializationError_.Create_IntOverflow_())
	_ = _0_valueOrError0
	if (_0_valueOrError0).IsFailure() {
		return (_0_valueOrError0).PropagateFailure()
	} else {
		return Companion_Default___.Text(m_Std_JSON_Utils_Views_Core.Companion_View___.OfBytes(bs))
	}
}
