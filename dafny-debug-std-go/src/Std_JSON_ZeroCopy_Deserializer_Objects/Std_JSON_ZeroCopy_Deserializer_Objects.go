...
func (_static *CompanionStruct_Default___) Object(cs m_Std_JSON_Utils_Cursors.Cursor__, json func(m_Std_JSON_Utils_Cursors.Cursor__) m_Std_Wrappers.Result) m_Std_Wrappers.Result {
...
func (_static *CompanionStruct_Default___) Open(cs m_Std_JSON_Utils_Cursors.Cursor__) m_Std_Wrappers.Result {
	var _0_valueOrError0 m_Std_Wrappers.Result = (cs).AssertByte(m_Std_JSON_ZeroCopy_Deserializer_ObjectParams.Companion_Default___.OPEN())
	_ = _0_valueOrError0
	if (_0_valueOrError0).IsFailure() {
		return (_0_valueOrError0).PropagateFailure()
	} else {
...
func (_static *CompanionStruct_Default___) Close(cs m_Std_JSON_Utils_Cursors.Cursor__) m_Std_Wrappers.Result {
	var _0_valueOrError0 m_Std_Wrappers.Result = (cs).AssertByte(m_Std_JSON_ZeroCopy_Deserializer_ObjectParams.Companion_Default___.CLOSE())
	_ = _0_valueOrError0
	if (_0_valueOrError0).IsFailure() {
		return (_0_valueOrError0).PropagateFailure()
	} else {
...
func (_static *CompanionStruct_Default___) AppendWithSuffix(elems m_Std_JSON_Utils_Cursors.Split, elem m_Std_JSON_Utils_Cursors.Split, sep m_Std_JSON_Utils_Cursors.Split) m_Std_JSON_Utils_Cursors.Split {
	var _0_suffixed m_Std_JSON_Grammar.Suffixed = m_Std_JSON_Grammar.Companion_Suffixed_.Create_Suffixed_((elem).Dtor_t().(m_Std_JSON_Grammar.JKeyValue), m_Std_JSON_Grammar.Companion_Maybe_.Create_NonEmpty_((sep).Dtor_t().(m_Std_JSON_Grammar.Structural)))
	_ = _0_suffixed
...
func (_static *CompanionStruct_Default___) AppendLast(elems m_Std_JSON_Utils_Cursors.Split, elem m_Std_JSON_Utils_Cursors.Split, sep m_Std_JSON_Utils_Cursors.Split) m_Std_JSON_Utils_Cursors.Split {
	var _0_suffixed m_Std_JSON_Grammar.Suffixed = m_Std_JSON_Grammar.Companion_Suffixed_.Create_Suffixed_((elem).Dtor_t().(m_Std_JSON_Grammar.JKeyValue), m_Std_JSON_Grammar.Companion_Maybe_.Create_Empty_())
	_ = _0_suffixed
...
TAIL_CALL_START:
	var _0_valueOrError0 m_Std_Wrappers.Result = m_Std_JSON_ZeroCopy_Deserializer_ObjectParams.Companion_Default___.Element((elems).Dtor_cs(), json)
	_ = _0_valueOrError0
	if (_0_valueOrError0).IsFailure() {
		return (_0_valueOrError0).PropagateFailure()
	} else {
		...
		if ((_1_elem).Dtor_cs()).EOF_q() {
			...
			if ((_3_s0) == (int16(Companion_Default___.SEPARATOR()))) && (((((_2_sep).Dtor_t().(m_Std_JSON_Grammar.Structural)).Dtor_t().(m_Std_JSON_Utils_Views_Core.View__)).Length()) == (uint32(1))) {
				...
				elems = _in2
				goto TAIL_CALL_START
			} else if ((_3_s0) == (int16(m_Std_JSON_ZeroCopy_Deserializer_ObjectParams.Companion_Default___.CLOSE()))) && (((((_2_sep).Dtor_t().(m_Std_JSON_Grammar.Structural)).Dtor_t().(m_Std_JSON_Utils_Views_Core.View__)).Length()) == (uint32(1))) {
				...
				_ = _9_separator
				var _10_pr m_Std_Wrappers.Result = m_Std_Wrappers.Companion_Result_.Create_Failure_(m_Std_JSON_Utils_Cursors.Companion_CursorError_.Create_ExpectingAnyByte_(_dafny.SeqOf(m_Std_JSON_ZeroCopy_Deserializer_ObjectParams.Companion_Default___.CLOSE(), _9_separator), _3_s0))
				_ = _10_pr
				return _10_pr
			}
		}
...
func (_static *CompanionStruct_Default___) Bracketed(cs m_Std_JSON_Utils_Cursors.Cursor__, json func(m_Std_JSON_Utils_Cursors.Cursor__) m_Std_Wrappers.Result) m_Std_Wrappers.Result {
	var _0_valueOrError0 m_Std_Wrappers.Result = m_Std_JSON_ZeroCopy_Deserializer_Core.Companion_Default___.Structural(cs, func(coer56 func(m_Std_JSON_Utils_Cursors.Cursor__) m_Std_Wrappers.Result) func(m_Std_JSON_Utils_Cursors.Cursor__) m_Std_Wrappers.Result {
		return func(arg57 m_Std_JSON_Utils_Cursors.Cursor__) m_Std_Wrappers.Result {
			return coer56(arg57)
		}
	...
	if (_0_valueOrError0).IsFailure() {
		...
		_ = _2_elems
		if (((_1_open).Dtor_cs()).Peek()) == (int16(m_Std_JSON_ZeroCopy_Deserializer_ObjectParams.Companion_Default___.CLOSE())) {
			var _3_p func(m_Std_JSON_Utils_Cursors.Cursor__) m_Std_Wrappers.Result = Companion_Default___.Close
			_ = _3_p
			var _4_valueOrError1 m_Std_Wrappers.Result = m_Std_JSON_ZeroCopy_Deserializer_Core.Companion_Default___.Structural((_1_open).Dtor_cs(), func(coer57 func(m_Std_JSON_Utils_Cursors.Cursor__) m_Std_Wrappers.Result) func(m_Std_JSON_Utils_Cursors.Cursor__) m_Std_Wrappers.Result {
				return func(arg58 m_Std_JSON_Utils_Cursors.Cursor__) m_Std_Wrappers.Result {
					return coer57(arg58)
				}
			}(_3_p))
			_ = _4_valueOrError1
...
func (_this *CompanionStruct_Jopen_) Witness() m_Std_JSON_Utils_Views_Core.View__ {
	return m_Std_JSON_Utils_Views_Core.Companion_View___.OfBytes(_dafny.SeqOf(m_Std_JSON_ZeroCopy_Deserializer_ObjectParams.Companion_Default___.OPEN()))
}
...
func (_this *CompanionStruct_Jclose_) Witness() m_Std_JSON_Utils_Views_Core.View__ {
	return m_Std_JSON_Utils_Views_Core.Companion_View___.OfBytes(_dafny.SeqOf(m_Std_JSON_ZeroCopy_Deserializer_ObjectParams.Companion_Default___.CLOSE()))
}
