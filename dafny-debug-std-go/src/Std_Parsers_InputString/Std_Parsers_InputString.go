// Package Std_Parsers_InputString
// Dafny module Std_Parsers_InputString compiled into Go
...
func (*Default__) String() string {
	return "Std_Parsers_InputString.Default__"
}
...
func (_static *CompanionStruct_Default___) ToInput(r _dafny.Sequence) m_Std_Collections_Seq.Slice {
	return m_Std_Collections_Seq.Companion_Slice_.Create_Slice_(r, _dafny.Zero, _dafny.IntOfUint32((r).Cardinality()))
}
func (_static *CompanionStruct_Default___) View(self m_Std_Collections_Seq.Slice) _dafny.Sequence {
	return (self).View()
}
func (_static *CompanionStruct_Default___) Length(self m_Std_Collections_Seq.Slice) _dafny.Int {
	return (self).Length()
}
func (_static *CompanionStruct_Default___) CharAt(self m_Std_Collections_Seq.Slice, i _dafny.Int) _dafny.CodePoint {
	return (self).At(i).(_dafny.CodePoint)
}
func (_static *CompanionStruct_Default___) Drop(self m_Std_Collections_Seq.Slice, start _dafny.Int) m_Std_Collections_Seq.Slice {
	return (self).Drop(start)
}
func (_static *CompanionStruct_Default___) Slice(self m_Std_Collections_Seq.Slice, start _dafny.Int, end _dafny.Int) m_Std_Collections_Seq.Slice {
	return (self).Sub(start, end)
}
func (_static *CompanionStruct_Default___) Equals_(self m_Std_Collections_Seq.Slice, other m_Std_Collections_Seq.Slice) bool {
...
func New_Input_() *Input {
	_this := Input{}

	return &_this
}

type CompanionStruct_Input_ struct {
}

var Companion_Input_ = CompanionStruct_Input_{}

func (*Input) String() string {
	return "Std_Parsers_InputString.Input"
}

// End of class Input

func Type_Input_() _dafny.TypeDescriptor {
	return type_Input_{}
}

type type_Input_ struct {
}

func (_this type_Input_) Default() interface{} {
	return m_Std_Collections_Seq.Companion_Slice_.Default()
}

func (_this type_Input_) String() string {
	return "Std_Parsers_InputString.Input"
}
