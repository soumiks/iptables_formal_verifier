...
func (_static *CompanionStruct_Default___) OfNat(n _dafny.Int) _dafny.Sequence {
	return m_Std_Strings_DecimalConversion.Companion_Default___.OfNat(n)
}
func (_static *CompanionStruct_Default___) OfInt(n _dafny.Int) _dafny.Sequence {
	return m_Std_Strings_DecimalConversion.Companion_Default___.OfInt(n, _dafny.CodePoint('-'))
}
func (_static *CompanionStruct_Default___) ToNat(str _dafny.Sequence) _dafny.Int {
	return m_Std_Strings_DecimalConversion.Companion_Default___.ToNat(str)
}
func (_static *CompanionStruct_Default___) ToInt(str _dafny.Sequence) _dafny.Int {
	return m_Std_Strings_DecimalConversion.Companion_Default___.ToInt(str, _dafny.CodePoint('-'))
}
func (_static *CompanionStruct_Default___) EscapeQuotes(str _dafny.Sequence) _dafny.Sequence {
	return m_Std_Strings_CharStrEscaping.Companion_Default___.Escape(str, _dafny.SetOf(_dafny.CodePoint('"'), _dafny.CodePoint('\'')), _dafny.CodePoint('\\'))
}
func (_static *CompanionStruct_Default___) UnescapeQuotes(str _dafny.Sequence) m_Std_Wrappers.Option {
	return m_Std_Strings_CharStrEscaping.Companion_Default___.Unescape(str, _dafny.CodePoint('\\'))
}
