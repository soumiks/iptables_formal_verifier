...
func (_static *CompanionStruct_Default___) Serialize(s _dafny.Sequence) _dafny.Sequence {
	return m_Std_Collections_Seq.Companion_Default___.Map(func(coer21 func(uint8) uint8) func(interface{}) interface{} {
		return func(arg22 interface{}) interface{} {
			return coer21(arg22.(uint8))
		}
	}(func(_0_c uint8) uint8 {
		return uint8(_0_c)
	}), s)
}
func (_static *CompanionStruct_Default___) Deserialize(b _dafny.Sequence) _dafny.Sequence {
	return m_Std_Collections_Seq.Companion_Default___.Map(func(coer22 func(uint8) uint8) func(interface{}) interface{} {
		return func(arg23 interface{}) interface{} {
			return coer22(arg23.(uint8))
		}
	}(func(_0_b uint8) uint8 {
		return uint8(_0_b)
	}), b)
}
