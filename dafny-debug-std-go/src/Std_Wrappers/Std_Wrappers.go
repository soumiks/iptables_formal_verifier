...
func (_this Result) ToOutcome() Outcome {
	{
		...
		}
		{
			var _1_e interface{} = _source0.Get_().(Result_Failure).Error
			_ = _1_e
			return Companion_Outcome_.Create_Fail_(_1_e)
		}
	}
}
...
func (_this Outcome) ToOption(r interface{}) Option {
	{
		...
		{
			var _0_e interface{} = _source0.Get_().(Outcome_Fail).Error
			_ = _0_e
			return Companion_Option_.Create_None_()
		}
	}
...
func (_this Outcome) ToResult(r interface{}) Result {
	{
		...
		}
		{
			var _0_e interface{} = _source0.Get_().(Outcome_Fail).Error
			_ = _0_e
			return Companion_Result_.Create_Failure_(_0_e)
		}
	}
}
...
func (_this Outcome) MapFailure(rewrap func(interface{}) interface{}, default_ interface{}) Result {
	{
		...
		}
		{
			var _0_e interface{} = _source0.Get_().(Outcome_Fail).Error
			_ = _0_e
			return Companion_Result_.Create_Failure_((rewrap)(_0_e))
		}
	}
}
